<template>
  <div>
    <el-table :style="tableStyle" :data="data">
      ...
      <el-table-column prop="frontCameraRTSP" label="前摄像头RTSP">
      </el-table-column>
      <el-table-column prop="backCameraRTSP" label="后摄像头RTSP">
      </el-table-column>
      <el-table-column prop="action" label="操作">
        <template slot-scope="scope">
          <el-button @click="handleEdit(scope.row)" type="text">编辑</el-button>
          <el-button @click="handleDelete(scope.row)" type="text">
            <span :style="{ color: '#FF3652' }">删除</span>
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  import { deviceDelete } from "@/services/console.js";
  export default {
    data() {
      return {
        tableStyle: {
