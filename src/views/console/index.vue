...
<div class="console-container">
  <el-tabs v-model="activeName" @tab-click="handleClick">
    ...
    <el-tab-pane label="安检点" name="site">
      ...
      <site-list :updateList="deviceGroupSearch" :handleEdit="handleEditSite" :data="siteData"></site-list>
    </el-tab-pane>
  ...
  <el-dialog width="72%" :destroy-on-close="true" :visible="addDeviceVisible" :append-to-body="true" @close="deviceDialogCloseHandle">
    <add-device :activeSiteRow="activeSiteRow" :updateList="deviceGroupSearch" @close="deviceDialogCloseHandle"></add-device>
  </el-dialog>
  <el-dialog title="添加EC200" :destroy-on-close="true" :visible="addEcVisible" :append-to-body="true" @close="addEcVisible = false">
