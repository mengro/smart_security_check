  ...
  <div class="form-container">
    <el-form ref="formRef" :rules="rules" :model="formModel" label-width="120px">
      <el-form-item class="form-item" prop="orientation" label="场馆">
        <el-input class="input" placeholder="请输入内容" v-model="formModel.orientation" />
      </el-form-item>
      <el-form-item class="form-item" prop="coordinate" label="安检口">
        <el-input class="input" placeholder="请输入内容" v-model="formModel.coordinate" />
      </el-form-item>
      <el-form-item class="form-item" prop="code" label="序号">
        <el-input placeholder="请输入数字" class="input" v-model="formModel.code" />
      </el-form-item>
      <el-form-item class="form-item" prop="longitude" label="地图定位">
        <el-input placeholder="经度" class="input half" v-model="formModel.longitude" />
        <el-input placeholder="纬度" :style="{ marginLeft: '20px' }" class="input half" v-model="formModel.latitude" />
        <span @click="
              (e) => {
            ...
            " class="position-setting">地图定位</span>
      </el-form-item>
      <el-form-item class="form-item" prop="xrayCode" label="X光机AI编号">
        <el-input placeholder="请输入内容" class="input" v-model="formModel.xrayCode" />
      </el-form-item>
      <el-form-item class="form-item" prop="cameraCoreId" label="EC200">
        <el-select :style="{width: '100%'}" placeholder="请选择EC200" class="input" v-model="formModel.cameraCoreId">
          <el-option v-for="item in ecList" :key="item.id" :label="item.code" :value="item.id">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item class="form-item" prop="frontCameraRTSP" label="前摄像头RTSP">
        <el-input placeholder="请输入拉流地址：rtsp://" class="input half" v-model="formModel.frontCameraRTSP" />
      ...
      <el-form-item class="form-item" prop="backCameraRTSP" label="后摄像头RTSP">
        <el-input placeholder="请输入拉流地址：rtsp://" class="input half" v-model="formModel.backCameraRTSP" />
        <span class="camera-name">
          <span class="camera-label">
            后摄像头通道名：
          </span>
