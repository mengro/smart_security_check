...
<div class="console-container">
  <el-tabs v-model="activeName" @tab-click="handleClick">
    ...
    <el-tab-pane label="安检点" name="site">
      ...
      <site-list :handleEdit="handleEditSite" :data="siteData"></site-list>
    </el-tab-pane>
  ...
  <el-dialog :destroy-on-close="true" :visible="addDeviceVisible" :append-to-body="true" @close="addDeviceVisible = false">
    <add-device :activeSiteRow="activeSiteRow" :updateList="deviceGroupSearch" @close="addDeviceVisible = false"></add-device>
  </el-dialog>
