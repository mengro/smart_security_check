...
<div class="index" :style="{ height: pageHeight + 'px' }">
  <div class="content">
              ...
              <div class="video-list-container">
                <ul class="video-list">
                  <li @click="(e) => setActiveAlarm(item, e)" :key="item.time" v-for="item in videoList" class="video-item">
                    ...
                    <img v-show="activeAlarmObj.id === item.id" class="activeTag" src="../../assets/images/alarmModalActiveTag.png" alt />
                  </li>
                </ul>
              </div>
            </div>
    ...
    <alarm-image v-if="!!activeAlarmObj.id" @close="
          () => {
            $modal.hide('alarm-image');
            activeAlarmObj = {};
          }
        " :activeAlarmObj="activeAlarmObj" :name="`${activeDevice.coordinate}-${activeDevice.orientation}-${activeDevice.code}`"></alarm-image>
  </div>
